...
WHERE b.VERSAO_PS = '2021-1' and b.ID_VOLUNT = a.ID_VOLUNT and c.ID_VOLUNT = a.ID_VOLUNT AND d.ID_DISCIPLINA = c.ID_DISCIPLINA and c.OPCAO = 1
...
WHERE b.VERSAO_PS = '2021-1' and b.ID_VOLUNT = a.ID_VOLUNT and c.ID_VOLUNT = a.ID_VOLUNT AND d.ID_DISCIPLINA = c.ID_DISCIPLINA
...
WHERE a.IS_VOLUNT = b.ID_VOLUNT AND a.VERSAO_PS = '2021-1' AND a.TIPO_VOLUNTARIO = 'P'