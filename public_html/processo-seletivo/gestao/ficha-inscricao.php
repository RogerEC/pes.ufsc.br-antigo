...
<?php }else if($cadastro_existente){ 
        ...
        $nome_ps = ($info_inscrito->TIPO_INFO == 'P')? "Processo Seletivo de Professores 2021-1":"Processo Seletivo de Gestores 2021-1";
            ...
            <div class="coluna-formulario container-fluid">
                <form action="" method="POST" id="FormularioGestao">
                    <div id="INICIO" class="corpo">
                        <div class="conteudo">
                            <div class="titulo">Ficha de Inscrição - Processo Seletivo de Gestores 2021-1</div>
                                ...
                                <p class="text-justify">Antes de começar a preencher a ficha de inscrição, reiteramos a importância da leitura completa do <b><a href="/processo-seletivo/gestao/2021/Edital_N01PES2021.pdf" target="_blank">EDITAL Nº 01/PES/2021</a></b>. 
                                Nele estão contidas todas as regras, etapas e datas do Processo Seletivo. Caso ainda sim a qualquer momento você tenha alguma dúvida sobre o processo seletivo, você pode entrar em contato com a equipe do Cursinho PES  
                                ...
                                <div class="subtitulo">Instruções para o preenchimento da ficha de inscrição</div>
                                    ...
                                    <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                        ...
                                        <label class="custom-control-label" for="ConfirmaLeituraEdital">Eu declaro que realizei a leitura do <b>Edital Nº 01/PES/2021</b>, aceito seu termos e quero participar do Processo Seletivo de Gestores 2021-1.</label>
                                    </div>
                ...
                <div id="FINALIZAR" class="d-none corpo">
                    ...
                    <div class="rodape">
                        <a class="btn btn-verde" href="/processo-seletivo/gestao/">Encerrar Inscrição</a>
                    </div>
                </div>
