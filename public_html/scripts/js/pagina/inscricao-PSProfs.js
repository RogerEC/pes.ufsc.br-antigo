$(document).ready(function(){
    ...
    function enviar_formulario(){
        ...
        var $form = $("#FormularioProfessores");
    ...
    function preencher_revisao(){
        ...
        $("#materia01REV").val($("#materia01 :selected").text());
        if($("#materia02").val()=="null"){
            $("#materia02REV").val("Nenhuma");
        }else{
            $("#materia02REV").val($("#materia02 :selected").text());
        }
        if($("#materia03").val()=="null"){
            $("#materia03REV").val("Nenhuma");
        }else{
            $("#materia03REV").val($("#materia03 :selected").text());
        }
    };
    ...
    $("#idade").change( function(){
        $("#FormularioProfessores").validate().element("#idade");
    });
    ...
    function remove_sel_botao(){
        ...
        $("#BotaoDisciplinaMotivacao").removeClass("btn-ativo");
    ...
    function validacao(limite){
        oculta_tudo();
        var validator = $("#FormularioProfessores").validate();
        $("#INICIO").removeClass("d-none");
        ...
        if(confirmar_leitura_edital()){
            ...
            if(validator.form()){
                $("#DADOS_PESSOAIS").addClass("d-none");
                $("#DISCIPLINA_MOTIVACAO").removeClass("d-none");
                if(limite=="BotaoDisciplinaMotivacao"){
                    $("#BotaoDisciplinaMotivacao").addClass("btn-ativo");
                    return;
                }
                if(validator.form()){
                    $("#DISCIPLINA_MOTIVACAO").addClass("d-none");
    ...
    $("#BotaoDisciplinaMotivacao").on("click", function(){
        validacao(this.id);
    });
    ...
    $("#Proximo01").on("click", function(){
        event.preventDefault();
        $("#BotaoDisciplinaMotivacao").click();
    });
