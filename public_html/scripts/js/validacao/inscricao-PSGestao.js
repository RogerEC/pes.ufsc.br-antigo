$("#FormularioGestao").validate({
    ...
    messages:{
        ...
        idade:{
            ...
            idade_min: "Você precisa ter 16 anos ou mais para se inscrever."
        },
        ...
        porque_setor:{
            required: "Informe o motivo da escolha da primeira opção de setor.",
...
jQuery.validator.addMethod("select_op2", function(value, element) {
    if(value==$("#setor01").val() && value!="null"){
        return this.optional(element) || false;
    }else{
        return this.optional(element) || true;
    }
}, "Selecione um valor diferente da sua 1ª OPÇÃO de setor.");

jQuery.validator.addMethod("select_op3", function(value, element) {
    if(value==$("#setor02").val() && value!="null"){
        return this.optional(element) || false;
    }else{
        return this.optional(element) || true;
    }
}, "Selecione um valor diferente da sua 2ª OPÇÃO de setor.");
